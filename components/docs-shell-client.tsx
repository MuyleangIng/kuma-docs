...
export function DocsShellClient({
  ...
  return (
    <div className="site-shell">
      <header className="site-header">
        <div className="site-topbar">
          <div className="site-topbar-left">
            <MobileMenuBtn
              className="site-menu-btn-mobile"
              isOpen={isMobileSidebarOpen}
              labelClosed="Open navigation"
              labelOpen="Close navigation"
              onToggle={() => setIsMobileSidebarOpen((open) => !open)}
            />
            <MobileMenuBtn
              className="site-menu-btn-desktop"
              isOpen={!isDesktopSidebarCollapsed}
              labelClosed="Expand navigation"
              labelOpen="Collapse navigation"
      ...
      {isOffline ? (
        <div className="site-offline-banner" role="status">
          You lost internet connection. Local docs search still works.
        </div>
      ) : null}

      <div className={`docs-layout${isDesktopSidebarCollapsed ? " is-sidebar-collapsed" : ""}`}>
        <DocsSidebar
