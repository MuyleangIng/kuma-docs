...
const PRODUCTS = [
  {
    id: "SNACK-01",
    name: "Palm Sugar Snack Box",
    desc: "Sweet market snacks and tasting notes",
    price: "11",
    currency: "USD",
  },
  {
    id: "TEA-01",
    name: "Lemongrass Tea Pack",
    desc: "Cafe blend with brew guide and refill pouch",
    price: "7",
    currency: "USD",
  },
];
  ...
  return (
    ...
    >
      <header style={{ marginBottom: 28 }}>
        <h1 style={{ fontSize: 28, margin: 0 }}>React + Vite KHQR JS Demo</h1>
